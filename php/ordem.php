...
<div class="text-right">
    <a class="btn btn-success btn-sm" type="button" value="Editar" href="../php/painel.php?page=addordem/"><img src="../img/baseline_person_add_white_24dp.png">&nbsp Criar Agenda</a>
</div>
...
<table class="table table-striped table-hover table-sm">
    ...
    <tbody>
        ...
        ?>
            <tr>
                <td><?php echo $obj->getOS(); ?></td>
                <td scope="row">
                    <?php
                    $cliente = $obj->getCliente();
                    $OS->selectCliente($cliente);
                    ?>
                </td>
                ...
                <td scope="row">
                    ...
                    $OS->selectUsuario($usuario);

                    ?>
                </td>
                <td><?php echo $obj->getResumo(); ?></td>
                <td><?php echo $obj->getHoraagendada(); ?></td>
