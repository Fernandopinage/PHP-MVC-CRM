...
class Colaborador extends Dao
{
    ...
    public function insertColaborador(ClassColaborador $ClassColaborador)
    {
        ...
        $insert->bindValue(":email", $ClassColaborador->getEmail());    /** */
        $insert->bindValue(":departamento", $ClassColaborador->getDepartamento());
        $insert->bindValue(":funcao", $ClassColaborador->getFuncao());
        $insert->bindValue(":foto", $ClassColaborador->getFoto());  /** */
        $insert->bindValue(":cpf", $ClassColaborador->getCpf());    /** */
        $insert->bindValue(":cnh", $ClassColaborador->getCnh());    /** */
        $insert->bindValue(":cnhcat", $ClassColaborador->getCnhcat());  /** */
        $insert->bindValue(":cnhvalid", $ClassColaborador->getCnhvalid());  /** */
        $insert->bindValue(":cnhemis", $ClassColaborador->getCnhemis());    /** */
        $insert->bindValue(":rg", $ClassColaborador->getRg());
        $insert->bindValue(":rgemis", $ClassColaborador->getRgemis()); /** */
        $insert->bindValue(":rguf", $ClassColaborador->getRguf()); /** */
        $insert->bindValue(":rgorg", "");   /** */
        $insert->bindValue(":titulo", $ClassColaborador->getTitulo());
        $insert->bindValue(":titulonum", $ClassColaborador->getTitulonum());    /** */
        $insert->bindValue(":titulozon", $ClassColaborador->getTitulozon());    /** */
        $insert->bindValue(":titulouf", $ClassColaborador->getTitulouf());  /** */
